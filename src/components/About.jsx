    ...
    return(
        <div id="about">
            <Box paddingLeft={7} paddingRight={7} paddingTop={5} paddingBottom={5}>
                ...
                <Typography>Experienced backend developer specializing in the Java/Spring tech stack. I've integrated systems using RESTful web services and implemented 
